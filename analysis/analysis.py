# analysis.py — Crime Evolution in Latin America 2015-2024: Database by Categories
...
keywords = ['Latin America', 'crime', 'homicides', 'drug trafficking']
...
print(f"Dataset: Crime Evolution in Latin America 2015-2024: Databa")
print(f"DOI: 10.5281/zenodo.18880580")
...
fig.suptitle("Crime Evolution in Latin America 2015-2024: Database by Cate", fontsize=11, fontweight="bold")
...
print(f"""
Citation:
de la Serna Tuya, Juan Moisés (2026). Crime Evolution in Latin America 2015-2024: Database by Categories. Zenodo. https://doi.org/10.5281/zenodo.18880580
""")
